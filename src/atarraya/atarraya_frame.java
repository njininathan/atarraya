 ...
 * atarraya_frame.java
 *
 * Created on July 18, 2006, 4:21 PM
 *
...
public class atarraya_frame extends javax.swing.JFrame implements constants{
    ...
    boolean batch_simulation;           // Condition that determines if the simulator is in batch_execution mode.
    ...
    double default_bit_error_rate = 0;
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Uniform", "Normal", "Constant", "Center", "Grid H-V", "Grid H-V-D", "Opt. Strip", "Opt. Comb", "Opt. Square", "Opt. Triangle", "Grid Delta", "Grid Poisson", "Cuadrant (Sinks only)" }));
        ...
        jButton5.setBounds(290, 150, 91, 23);
        ...
        jProgressBar2.setBounds(10, 130, 130, 19);
        ...
        jTextField32.setBounds(190, 150, 40, 20);

        jLabel81.setText("Width");
        jPanel7.add(jLabel81);
        jLabel81.setBounds(140, 130, 28, 14);

        jLabel82.setText("Height");
        jPanel7.add(jLabel82);
        jLabel82.setBounds(200, 130, 31, 14);

        jCheckBox8.setText("Move?");
        jPanel7.add(jCheckBox8);
        jCheckBox8.setBounds(230, 150, 57, 23);

        jComboBox13.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Simple", "Mote", "Libelium Waspmote", "Crossbow MICA2", "ACOS" }));
        ...
        jComboBox13.setBounds(240, 180, 100, 20);

        jLabel96.setText("<html>Energy <br> Model</html>");
        jPanel7.add(jLabel96);
        jLabel96.setBounds(350, 180, 40, 30);

        jTextField47.setText("30");
        jPanel7.add(jTextField47);
        jTextField47.setBounds(330, 90, 40, 20);

        jLabel103.setText("Pref. Radius");
        jPanel7.add(jLabel103);
        jLabel103.setBounds(300, 70, 80, 14);

        jComboBox12.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Simple", "WaspMote", "Mica2" }));
        ...
        jComboBox12.setBounds(240, 210, 100, 20);

        jLabel104.setText("<html>Comm<br> Model");
        jPanel7.add(jLabel104);
        jLabel104.setBounds(350, 210, 40, 28);
        ...
        jComboBox14.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Just Level", "Level + K", "Just K" }));
        ...
        jPanel28Layout.setHorizontalGroup(
            ...
            .add(jPanel28Layout.createSequentialGroup()
                .add(jPanel28Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, jComboBox14, 0, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel29.setBounds(220, 320, 160, 80);
        ...
        jComboBox7.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "No TC Protocol", "A3", "A3 Lite", "A3 Coverage", "A3 Lite Coverage", "EECDS", "CDS Rule K", "SimpleTree", "Just Tree", "KNEIGH-Tree" }));
        ...
        jProgressBar1.setBounds(10, 100, 190, 19);
        ...
        jPanel30Layout.setHorizontalGroup(
            ...
            .add(jPanel30Layout.createSequentialGroup()
                ...
                .add(jPanel30Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel30Layout.createSequentialGroup()
                        .add(jTextField46, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(jLabel102)
                        .add(25, 25, 25))
                    .add(jPanel30Layout.createSequentialGroup()
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .add(jPanel10Layout.createSequentialGroup()
                ...
                .add(jPanel10Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jScrollPane2, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 369, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(jPanel10Layout.createSequentialGroup()
                        .add(jButton4)
                        .add(20, 20, 20)
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 635, Short.MAX_VALUE)
        );
...
// TODO add your handling code here:
    ...
    public void UpdateStats(){
            ...
            stats="Clock: "+clock+
                                "\n# of Nodes: "+numnodes+
                                "\n# of Sinks: "+numsinks+
                                "\nSink 0 Comm radius"+getNode(numnodes).getRadius()+
...
/*
        ...
        try{
            ...
            _comm_model = jComboBox12.getSelectedIndex();
   ...
   public void setInterqueryTime(){
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        ...
        AboutFrame theAboutFrame = new AboutFrame();
        theAboutFrame.setBounds(100,100,600, 400);
...
private void jComboBox13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox13ActionPerformed
    ...
    switch(selected_energy_model){
        ...
        case SIMPLE_ENERGY_MODEL:
            jTextField22.setEnabled(true); // BER edit text
            jLabel54.setEnabled(true); // BER label
            jLabel51.setText("Node Energy Distribution (mJoules)");
            jTextField25.setText("1000");
            jTextField20.setText("1000");
        ...
        case WASPMOTE_ENERGY_MODEL:
            ...
            jLabel51.setText("Node Energy Distribution (mA-h)");
            jTextField25.setText("1150");
            jTextField20.setText("1150");
            MAX_ENERGY = MAX_ENERGY_WASPMOTE;
            jTextField46.setText(""+MAX_ENERGY);
            break;
        ...
        case MICA2_ENERGY_MODEL:
            ...
            jLabel54.setEnabled(false);
            jLabel51.setText("Node Energy Distribution (mA-h)");
            jTextField25.setText("2000");
            jTextField20.setText("2000");
            MAX_ENERGY = MAX_ENERGY_MICA2;
            jTextField46.setText(""+MAX_ENERGY);
            break;
...
private void jComboBox12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox12ActionPerformed
    // TODO add your handling code here:
     ...
     selected_comm_model = jComboBox13.getSelectedIndex();

    switch(selected_comm_model){
        ...
        case MICA2_COMM_MODEL:
            jTextField2.setText("230");
            jTextField2.setEnabled(false);
            jLabel7.setText("230");
            jTextField22.setEnabled(false);
            jTextField47.setText("90");
            jTextField7.setText("115");
            break;
...
private void jComboBox14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox14ActionPerformed
    ...
    kneigh_type = jComboBox14.getSelectedIndex();
...
public double calc_combinations(int k, int n){
                        ...
                        if(temp_read.length > 3){
                            ...
                            if(temp_read.length > 9)
                             ...
                             if(temp_read.length > 10)
                                comm_model = Integer.parseInt(temp_read[10]);

                            mynodes.add(new node(i, new Point(positionx,positiony), energy, temp_radius, temp_sense_radius,interquery_time_,weight_e,weight_d,motion,energy_model, comm_model));
                        }else
    ...
    public int NodeGeneratorByWord(String s){
        ...
        try{
            ...
            comm_model = Integer.parseInt(the_word[20]);
            if(the_word.length == 21)
                comm_model = Integer.parseInt(the_word[20]);
            else{
                if(energy_model == WASPMOTE_ENERGY_MODEL)
                    comm_model = WASPMOTE_COMM_MODEL;
                else if(energy_model == MICA2_ENERGY_MODEL)
                    comm_model = MICA2_COMM_MODEL;
                else
                    comm_model = SIMPLE_COMM_MODEL;
            }
            ...
            for(i=0;i<numnodes_;i++){
                ...
                switch(pos_dist_){
                    ...
                    switch(tree_sel_){
                        ...
                        //Create the strips
                        limit_h = (int)(java.lang.Math.ceil(h/2));
                        limit_w = (int)(java.lang.Math.ceil(w/2));
                        ...
                        //Create the strips
                        limit_h = (int)(java.lang.Math.ceil(h/4));
                        limit_w = (int)(java.lang.Math.ceil(w/4));
                        ...
                        //Create the strips
                        limit_h = (int)(java.lang.Math.ceil(h/4));
                        limit_w = (int)(java.lang.Math.ceil(w/4*3));
                        ...
                        //Create the strips
                        limit_h = (int)(java.lang.Math.ceil(h/4*3));
                        limit_w = (int)(java.lang.Math.ceil(w/4));
                    ...
                    p=GaussianRandomGenerator(limit_w,limit_h,pos_param);
                    x=p.x;
                    y=p.y;
                ...
                mynodes.add(new node(current_node_count, new Point(x,y), energy, comm_rad_, sense_rad_,interquery_time_,weight_e,weight_d,moving, energy_model, comm_model));
                if(sink_==1){
                ...
                case GRID_OPT_SQUARE:
                    ...
                    for(i=0;i<limit_h;i++){
                        for(j=0;j<limit_w;j++){
                            ...
                            mynodes.add(new node(current_node_count, p, energy, comm_rad_, sense_rad_,interquery_time_,weight_e,weight_d,moving, energy_model, comm_model));
                            current_node_count++;
    ...
    protected class newpanel extends JPanel implements MouseListener, MouseMotionListener, constants{
        ...
        public void saveComponentAsJPEG(String filename) {
            ...
            try {
                ...
                java.awt.image.RenderedImage rendImage = myImage;
                    ...
                    if(tempevent_ != null && !sw && !simfin_){
                        ...
                        if(tempevent_.isValid()){
                            ...
                            if(tempevent_.getMessageType() != 0){
                                ...
                                // Open air communication models
                                // Finds bit error rate according to the distance between nodes, for
                                // Waspmote (2.4 GHz ZigBee, OQPSK) and MICA2 (915 MHz RF, FSK)
                                // By César Cordoba and Armando Guerrero
                                // Contact: ccordoba@uninorte.edu.co || amondul@uninorte.edu.co
                                //if (selected_energy_model == WASPMOTE_ENERGY_MODEL) {
                                /*temp_energy_model = getNode(tempevent_.getSender()).getEnergy_model_index();
                                if (temp_energy_model == WASPMOTE_ENERGY_MODEL) {
                                    lambda = 299792458 / 2.4E9; // lambda = c / f; f: 2.4 GHz for ZigBee
                                    // Open air path loss, alpha = 2
                                    lp = 22 + 20*Math.log10(temp_radius / lambda);
                                    ...
                                    bit_error_rate = Q(Math.sqrt(2 * Math.pow(10, ebno/10))); // Equation (8.18)
                                }

                                else if (temp_energy_model == MICA2_ENERGY_MODEL) {
                                    lambda = 299792458 / 915E6; // f: 915 MHz
                                    lp = 22 + 20*Math.log10(temp_radius / lambda); // Path loss
                                    ...
                                    bit_error_rate = Q(Math.sqrt(Math.pow(10, ebno/10))); // Equation (8.42)
                                }
                                bit_energy = ebno;
                                ber = bit_error_rate;

                                prob_error = 1.0-java.lang.Math.pow(1.0-bit_error_rate,8*size_packet);*/
                                ...
                                if(tempevent_.getMessageType() == OPER_RX && rx_message && tx_message){
                                    ...
                                    //temp_distance = getNode(tempevent_.getSender()).calcDistance(getNode(tempevent_.getReceiver()));
                                    //bit_error_rate = getNode(tempevent_.getSender()).getCommModel().calcBER(temp_distance);
                                    temp_node = getNode(tempevent_.getSender()).getNeighborFromID(tempevent_.getReceiver());
                                    if(temp_node != null)
                                        bit_error_rate = temp_node.getBer();
                                    else
                                        bit_error_rate = 1;
                                    
                                    if(bit_error_rate == -1)
                                        bit_error_rate = default_bit_error_rate;
                                    
                                    prob_error = 1.0-java.lang.Math.pow(1.0-bit_error_rate,8*size_packet);
                                    //System.out.println(""+prob_error);
    ...
    */
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new atarraya_frame().setVisible(true);
            }
        });
    }
