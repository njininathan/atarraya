 ...
 * @author Research
 */
public class AcosEnergyModel implements EnergyModel, constants{
    ...
    public static final double PROCESSOR_IDLE_CONSUMPTION= 8;
    //public static final double PROCESSOR_SLEEP_CONSUMPTION= 0.103;
    public static final double PROCESSOR_SLEEP_CONSUMPTION= 0.015;
    ...
    public static final double RADIO_TX_CONSUMPTION= 27;
    //public static final double RADIO_RX_CONSUMPTION= 7;
    public static final double RADIO_RX_CONSUMPTION= 10;
    public static final double RADIO_SLEEP_CONSUMPTION= 0.001;

    //public static final double RADIO_TX_RX_TIME_BYTE= 416e-6;
    public static final double RADIO_TX_RX_TIME_BYTE= 8.0/19200.0; //Time to transmit 8 bits (1 Byte) at the 19.2Kbps
    ...
    public AcosEnergyModel(node the_node_){
        the_node = the_node_;
...
public double calcEnergy(int oper, double time){
        ...
        switch(oper){
            case OPER_TX_REGULAR:
                ...
                //Time to tramit 40 bytes
                temp_time = SIZE_SHORT_PACKETS * RADIO_TX_RX_TIME_BYTE;

                //ener = RADIO_TX_CONSUMPTION*temp_time;
                ...
                ener = temp_time * calcEnergyStateConsumption(STATE_FULL_ACTIVE);
            ...
            case OPER_TX_LONG:
                ...
                temp_time = SIZE_LONG_PACKETS * RADIO_TX_RX_TIME_BYTE;
            ...
            case OPER_RX_REGULAR:
                ...
                ener = temp_time * calcEnergyStateConsumption(STATE_ACTIVE);
                break;
