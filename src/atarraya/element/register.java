 ...
 */   
    ...
    /** Creates a new instance of register */
    public register(int _ID, int _address, double _distance, double _energy, int _mode, int _sortingmode, double _ber) {
            ID = _ID;
            address = _address;
            distance = _distance;
            energy = _energy;
    ...
    public String toString(){
        return ""+ID+"-"+address+"-"+getDistance()+"-"+getEnergy()+"-"+getBer();
    }
