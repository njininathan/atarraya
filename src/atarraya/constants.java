 ...
 * constants.java
 *
 * Created on July 19, 2006, 11:55 AM
 *
...
public interface constants {
    ...
    // New, added for Libelium Waspmote and Crossbow MICA2 energy consumption models
    public static int ACOS_ENERGY_MODEL = 4;
    public static int WASPMOTE_ENERGY_MODEL = 2;
    public static int MICA2_ENERGY_MODEL = 3;


    public static int SIMPLE_COMM_MODEL = 0;
    public static int WASPMOTE_COMM_MODEL = 1;
    public static int MICA2_COMM_MODEL = 2;
    ...
    // New, added for Libelium Waspmote and Crossbow MICA2 energy consumption models
    public static double MAX_ENERGY_WASPMOTE = 1150;  //Charge in mA-hr on the sensor
    public static double MAX_ENERGY_MICA2 = 2000;  //Charge in mA-hr on the sensor
    ...
    public static int PROTOCOL_A3_LITE = 2;
    public static int PROTOCOL_A3_COV = 3;
    public static int PROTOCOL_A3_LITE_COV = 4;
    public static int PROTOCOL_ECDS = 5;
    public static int PROTOCOL_CDS_RULEK = 6;
    public static int PROTOCOL_SIMPLE_TREE = 7;
    public static int PROTOCOL_JUST_TREE = 8;
    public static int PROTOCOL_KNEIGH = 9;
    ...
    public static int PREF_RADIUS = 25;
    ...
    public static final int CHECK_CHILDREN_RECOGNITION = 40;
    ...
    public static int KN_JUST_LEVEL = 0;
    public static int KN_LEVEL_AND_K = 1;
    public static int KN_JUST_K = 2;
